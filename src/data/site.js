...
export const projects = [
  ...
  },
  {
    ...
    tags: ["Data Analysis", "CSV", "Visualization", "Jupyter"],
  ...
  {
    name: "Spotify Web",
    slug: "html-css-spotifyweb",
    description: {
      it: "Reproduzione responsive curata nel dettaglio per raccontare precisione visiva, layout e disciplina sul frontend.",
      en: "A detail-oriented responsive reproduction that highlights visual precision, layout work, and frontend discipline.",
    },
    tags: ["Responsive", "HTML", "CSS", "UI"],
...
export const ui = {
  it: {
    ...
    resumeStatusTitle: "CV in revisione",
    resumeStatusCopy:
  ...
  en: {
    ...
    githubLabel: "GitHub",
    linkedinLabel: "LinkedIn",
    resumeStatusTitle: "Resume in redesign",
    resumeStatusCopy:
